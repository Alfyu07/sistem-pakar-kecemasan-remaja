...
import 'package:sistem_pakar/services/services.dart';
...
part 'pakar_controller.dart';
part 'gejala_controller.dart';
part 'penyakit_controller.dart';
part 'proses_controller.dart';
